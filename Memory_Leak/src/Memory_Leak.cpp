...
//***************************************************//
const int STEP_LEVEL = 8; // CHANGE STEP_LEVEL VALUE WHEN REQUESTED //
///***************************************************//
...
int main()
{
    ...
    if (STEP_LEVEL >= 2) {
        ...
        cout << "delete b" << endl;
        cout << "b\t" << b << '\t' << *b << endl << endl;
        // Above might throw exception,
        //  if it does, comment out this line before moving on to
        //   STEP_LEVEL = 3 so that subsequent STEP_LEVEL values
        //     compile and run
    }
